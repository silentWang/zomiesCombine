...
var GroundItem = /** @class */ (function (_super) {
    ...
    GroundItem.prototype.setIndex = function (i) {
        ...
        var str = Config_1.Config_ground[i - 1].price + "\u7EA7";
