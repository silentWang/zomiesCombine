...
typedef NS_ENUM(NSInteger, ATOfferClickAdType) {
    ...
    ATOfferClickAdTypeAutoClickAfterDelay,
    ATOfferClickAdTypeAutoClickAfterFinish,
    ATOfferClickAdTypeShakeClick,
    ATOfferClickAdTypeOverlyClick,
    ATOfferClickAdTypeStoresKitClick
};
