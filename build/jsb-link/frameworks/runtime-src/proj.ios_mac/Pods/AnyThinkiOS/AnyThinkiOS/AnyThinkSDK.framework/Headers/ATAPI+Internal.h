...
/// decide domain name, if RU, change host.
/// @param name second-level domain name
/// @param path path 
- (NSString *)fullURLStringWithSecondLevelDomainName:(NSString *)name path:(NSString *)path;
- (NSString *)fullURLStringWithSecondLevelDomainName:(NSString *)name;
