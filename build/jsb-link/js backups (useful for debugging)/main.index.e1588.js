...
var s = t("./framwork/BaseUI"), l = t("./manager/AdCenter"), u = t("./manager/ChickData"), d = t("./manager/PoolMgr"), x = t("./manager/WxCenter"), f = t("./utils/AudioMgr"), h = t("./utils/Native"), p = t("./utils/Utils"), w = window.wx || window.tt, _ = cc._decorator, m = _.ccclass, y = _.property, g = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.img_shouquan = null;
...
if (w) {
w.setPreferredFramesPerSecond(60);
w.setKeepScreenOn({
keepScreenOn: !0
});
}
...
if (!(t >= 1)) return [ 3, 2 ];
this.node.stopAllActions();
return [ 4, p.default.loadBundler("spine") ];

case 1:
e.sent();
p.default.loadBundler("sounds").then(function() {
...
r([ y(cc.Node) ], e.prototype, "img_shouquan", void 0);
r([ y(cc.Node) ], e.prototype, "loading_bar", void 0);
return r([ m ], e);
}(s.default);
i.default = g;
cc._RF.pop();
