...
var r = t("./Singleton"), a = t("../utils/Utils"), c = t("./WxCenter"), s = t("../utils/Native"), l = window.tt, u = cc._decorator, h = (u.ccclass, 
u.property, function(t) {
o(e, t);
function e() {
...
e.videoAdID = l.createRewardedVideoAd({
...
l.createInterstitialAd && (e.interstitialAd = l.createInterstitialAd({
adUnitId: "60jin0has9p2b8n774"
}));
var i = l.getSystemInfoSync(), n = i.screenWidth, o = i.screenHeight;
e.bannerAd = l.createBannerAd({
...
this.callBack = t;
cc.sys.os === cc.sys.OS_IOS ? s.Native.playVideoAd(t, e) : t && t(1);
}
};
...
t.getComponent(A.default).setViewType(r);
}) : l.default.show("金币不足");
return;
}
...
var i;
e._instance = null;
r([ T(cc.Prefab) ], e.prototype, "enemy_pre", void 0);
r([ T(cc.Prefab) ], e.prototype, "pre_soldier", void 0);
return i = r([ M ], e);
}(s.default);
i.default = G;
cc._RF.pop();
